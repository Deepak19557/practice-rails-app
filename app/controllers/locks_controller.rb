class LocksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @lock.save
        format.html { redirect_to lock_url(@lock), notice: "Lock was successfully created." }
  ...
  def update
    respond_to do |format|
      if @lock.update(lock_params)
        format.html { redirect_to lock_url(@lock), notice: "Lock was successfully updated." }
  ...
  private
    ...
    def lock_params
      params.require(:lock).permit(:lock_name, :key_id)
    end
end
